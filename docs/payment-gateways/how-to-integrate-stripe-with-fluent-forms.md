...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/1.-Enable-Stripe-Payment-method-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/2.-Connect-with-Stripe-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/3.-Submit-button.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/4.-Add-stripe-webhook-URL-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/5.-Developers-Webhooks-scaled.webp)

Click the **+ Add destination** button.

![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/6.-Add-Destination-button-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/7.-Select-Events-scaled.webp)

Then, select the **Webhook endpoint** and again click the **Continue** button.

![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/8.-Webhook-endpoint-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/9.-Create-Destination-button-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/Open-desired-form-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/10.-Embed-checkout-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/11.-Save-form-scaled.webp)

## Preview of Added Payment Method

Here is the **preview** of the **Payment Method** that we just added. 

![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/12.-Form-Preview-.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/Open-Form-Settings-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/13.-Form-Specific-Stripe-Settings-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/14.-Stripe-meta-data-option.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/15.-Custom-Stripe-Credentials.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/16.-Stripe-Payment-Receipt.webp)
...
![](/images/payment-gateways/how-to-integrate-stripe-with-fluent-forms/17.-Statement-Descriptor.webp)
