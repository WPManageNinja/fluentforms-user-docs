...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/1.-Enable-Razorpay-method-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/2.-Test-API-Credentials-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/3.-API-Keys-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/4.-Regenerate-Test-Key-button-scaled.webp)

Here, you will get your desired **Key ID** and **Key Secret**, and copy them. 

![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/5.-Copy-Key-ID-and-Key-Secret.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/6.-Paste-API-Key-and-Secret-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/7.-Modal-Checkout-Style.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/8.-Hosted-to-Razorpay.com_.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/Open-desired-form-3-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/9.-Check-Razorpay-payment-method-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/10.-Save-Form-button-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/11.-Form-Preview-.webp)

Here is the preview of the **Razorpay Checkout Modal**. 

![](/images/payment-gateways/how-to-integrate-razorpay-with-fluent-forms/12.-Razorpay-payment-popup-1024x575.webp)
