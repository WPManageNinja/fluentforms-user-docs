...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/1.-Enable-Paddle-Payment-Method-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/2.-Test-API-Key--scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/3.-Generate-API-Key-button-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/4.-Generate-button-1.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/5.-copy-API-key.webp)

#### Generating Client Token

Now, go to the **Client-side tokens** section and click the **+ Generate client-side token** button.

![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/6.-Generate-Client-Side-Token.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/7.-Generate-token-button.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/8.-Copy-Token.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/9.-Deafult-payment-link-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/10.-Paste-API-key-and-Client-Token-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/Open-desired-form-2-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/11.-Add-paddle-in-desired-form-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/12.-Save-form-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/13.-Submit-form.webp)

Here is the preview of the **Paddle Checkout Modal**. 

![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/14.-Preview-of-Paddle.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/Open-Form-Settings-2-scaled.webp)
...
![](/images/payment-gateways/how-to-integrate-paddle-with-fluent-forms/15.-Form-specific-Paddle-payment-settings-scaled.webp)
