...
After adding the block, select a saved Fluent Forms from the **dropdown menu**. If you do not have one yet, [create a form with Fluent Forms](/how-to-create-a-form-with-fluent-forms) first.
...
> You can also add the form in Gutenberg by pasting the form [ShortCode](/fluent-forms-shortcodes-overview) into the Gutenberg ShortCode block or HTML block.
