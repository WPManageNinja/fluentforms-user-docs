...
![](/images/features-and-functionalities/set-default-form-value-from-url-parameters/unnamed-2-4.webp)
...
![](/images/features-and-functionalities/set-default-form-value-from-url-parameters/URL-populate-01-1-scaled.webp)
...
![](/images/features-and-functionalities/set-default-form-value-from-url-parameters/age--scaled.webp)

After that, **paste** it into the desired **page** or **post**.

![](/images/features-and-functionalities/set-default-form-value-from-url-parameters/table-of-parameter-.webp)
...
![](/images/features-and-functionalities/set-default-form-value-from-url-parameters/Url-parameter-f-scaled.webp)
...
![](/images/features-and-functionalities/set-default-form-value-from-url-parameters/333-scaled.webp)
