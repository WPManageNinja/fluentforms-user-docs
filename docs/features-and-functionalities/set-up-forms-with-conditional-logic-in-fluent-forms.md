...
**Fluent Forms** offers the **Conditional Logic** feature inside **Input Fields** to **display**/hide them based on specific conditions in your forms. This article will guide you through using **[Conditional Logic](/docs/set-up-forms-with-conditional-logic-in-fluent-forms)** in any **Input Fields** with **Fluent Forms**.
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/1.-Open-Desired-form-scaled.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/2.-Input-Customization-scaled.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/3.-Conditional-Match-scaled.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/4.-Any-conditional.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/5.-Preview-of-Any-condional-scaled.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/6.-All-condional.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/7.-Preview-of-All-Conditional.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/8.-Group-Conditional.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/9.-Preview-of-Group-one-codinitional.webp)
...
![](/images/features-and-functionalities/set-up-forms-with-conditional-logic-in-fluent-forms/10.-Preview-of-Group-two-Conditionals.webp)
