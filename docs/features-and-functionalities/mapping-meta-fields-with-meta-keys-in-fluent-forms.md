...
Start by creating a **Custom Post Form** or using an existing one. Ensure the **Field Group** is set to **Post Type**. To know more about creating post forms read this [article](/docs/how-to-create-a-post-form-with-fluent-forms). 
...
![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/Create-post-form-01-scaled.webp)
...
![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/unnamed-7.webp)
...
![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/post-field-and-meta-field-02-scaled.webp)
...
![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/MEta-Key-Field-03-scaled.webp)
...
![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/product-form-04-scaled.webp)
...
![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/add-product-field-05-scaled.webp)

![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/add-meta-field-06-scaled.webp)

After adding all the required meta keys, click the **Save Feed** button to save your configuration. Fill out and submit the form.

![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/unnamed-1-4.webp)
...
![](/images/features-and-functionalities/mapping-meta-fields-with-meta-keys-in-fluent-forms/preview-product-meta-key-07-scaled.webp)
