...
![use CSS Ready Classes step](/images/design-styling/use-css-ready-classes/321-scaled.webp)
...
This turns a [Radio](/radio-field)/[checkbox](/checkbox-field) list into an equally-spaced 2-column format. It only applies to Radio/checkbox lists and works with any form label position settings.
...
This is useful if you want to show a large amount of content to the user but don’t want to have to link to it or make the form very long to show it (Terms of Service Agreements, etc.). This class only works on [section breaks](/section-break) and with any form label position settings.

![Scroll Text](/images/design-styling/use-css-ready-classes/scroll-text-03-scaled.webp)
