...
First, navigate to the [Entries](/managing-entries-in-fluent-forms) section in your Fluent Forms dashboard. Each submission includes a **Submitted at** timestamp, showing the date and time when the form was submitted.
...
To add a more customized timestamp to your forms, open the form editor and add a [Hidden Field](/hidden-input-field-in-fluent-forms) from the **Advanced Fields** section.
