...
![](/images/configuring-forms/conditional-logic/set-default-form-value-from-url-parameters/age--scaled.webp)

After that, **paste** it into the desired **page** or **post**.

![](/images/configuring-forms/conditional-logic/set-default-form-value-from-url-parameters/table-of-parameter-.webp)
...
![](/images/configuring-forms/conditional-logic/set-default-form-value-from-url-parameters/Url-parameter-f-scaled.webp)
