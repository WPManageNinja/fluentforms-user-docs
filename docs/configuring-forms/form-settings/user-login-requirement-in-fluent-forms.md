...
Go to **Settings & Integrations → Settings → Scheduling & Restrictions**. In **Login Requirement Settings**, turn on **Require user to be logged in**. The same panel also controls [form restrictions](/form-restrictions-feature-in-fluent-forms) and scheduling.
...
This text helps users sign in or create an account before they can submit the form. To let visitors register from a form, see [How to Create a WordPress User Registration Form](/how-to-create-a-wordpress-user-registration-form-with-fluent-forms).
