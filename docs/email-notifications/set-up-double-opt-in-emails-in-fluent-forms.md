...
![](/images/email-notifications/set-up-double-opt-in-emails-in-fluent-forms/double-optionemail-settings-02-scaled.webp)
...
![](/images/email-notifications/set-up-double-opt-in-emails-in-fluent-forms/03-3-scaled-2.webp)
...
![](/images/email-notifications/set-up-double-opt-in-emails-in-fluent-forms/contact-form-scaled.webp)
...
![](/images/email-notifications/set-up-double-opt-in-emails-in-fluent-forms/04-3-scaled.webp)
...
![](/images/email-notifications/set-up-double-opt-in-emails-in-fluent-forms/initial-message-02.webp)

When the user confirms their subscription, an email notification will be triggered, completing the process.

![](/images/email-notifications/set-up-double-opt-in-emails-in-fluent-forms/email-confirmation-01.webp)
