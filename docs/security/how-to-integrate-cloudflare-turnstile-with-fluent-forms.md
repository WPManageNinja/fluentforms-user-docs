...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/1.-Cloudefare-Turnstile-Settings-page-scaled.webp)
...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/2.-Add-Widget-button-scaled.webp)
...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/3.-Add-Widget-and-Host-Name--scaled.webp)
...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/4.-Add-button.webp)
...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/5.-Create-button.webp)

Here, you will get your desired Site key and Secret key. Simply, copy them by clicking the **Site Key** and **Secret Key** buttons.

![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/6.-Copy-Site-Secret-Key-.webp)
...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/7.-Paste-keys-and-validate-turnstile-scaled.webp)

Once you have verified the keys, press the **Save Setting**s button to make your **Turnstile Integration** functional. 

![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/8.-Save-Settings-button-scaled.webp)
...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/6.-desired-Form-Editor-1-scaled.webp)
...
![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/10.-Add-Turnstile-input-field-scaled.webp)

Here is the preview of the integrated Turnstile in a specific form.

![](/images/security/how-to-integrate-cloudflare-turnstile-with-fluent-forms/11.-Preview-of-added-Turnstile-field.webp)
