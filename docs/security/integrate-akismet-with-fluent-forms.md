...
![](/images/security/integrate-akismet-with-fluent-forms/1.-Install-Akismat-scaled.webp)

Then, click the **Activate** button, and the Akismet plugin will be activated and ready to function.

![](/images/security/integrate-akismet-with-fluent-forms/2.-Active-Akismet-scaled.webp)
...
![](/images/security/integrate-akismet-with-fluent-forms/3.-Global-Settings-Miscellaneous-Enable-Akismet-scaled.webp)
