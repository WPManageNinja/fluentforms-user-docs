...
![](/images/miscellaneous/fluent-form-api-logs/1.-Tools-API-Logs-scaled.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/2.-Form-filter-option-1-scaled.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/3.-Source-filter-option-1-scaled.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/4.-Status-filter-option-1-scaled.webp)

#### 4. Date

With this option, you can filter your activities by selected **Dates** to see actions for specific days.

![](/images/miscellaneous/fluent-form-api-logs/5.-Date-filter-option-1-scaled.webp)

**To show the use of all filtering options at a glance, follow the GIF below:**

![](/images/miscellaneous/fluent-form-api-logs/6.-Forms-source-status-date-Drift-video.gif)
...
![](/images/miscellaneous/fluent-form-api-logs/7.-Single-API-check.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/8.-Detail-API-Log-check.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/9.-Submission-Logs-API-Calls-scaled.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/10.-Replay-Action-scaled.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/11.-Replay-action-in-bulk-scaled.webp)

### Delete API Logs

If you want to delete any API log, you can do it simply by clicking on the **Delete Icon** under the **Action** column.

![](/images/miscellaneous/fluent-form-api-logs/12.-Delete-single-log-scaled.webp)
...
![](/images/miscellaneous/fluent-form-api-logs/13.-Delete-logs-in-bulk-scaled.webp)
