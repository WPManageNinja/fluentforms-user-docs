...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/Webhook-Settings-FluentCRM-01-scaled.webp)
...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/create-weebhook-02-scaled.webp)

After creation, copy the **WebHook URL**. This will be used to link Fluent Forms to FluentCRM.

![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/create-weebhook-03-scaled.webp)
...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/Form-04-scaled.webp)
...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/enable-webhook-module-05-scaled.webp)
...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/add-webhook-06-scaled.webp)
...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/WebHook-Settings-07-scaled.webp)
...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/08.webp)
...
![](/images/miscellaneous/connecting-fluent-forms-from-one-domain-with-fluent-crm-to-another-domain/09-scaled.webp)
