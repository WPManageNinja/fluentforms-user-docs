...
> [!Note]
> **GetResponse** requires **Fluent Forms Pro**. See [Upgrade to Fluent Forms Pro Add-on](/upgrade-to-fluent-forms-pro-add-on).
...
![Generate API Key](/images/integrations/email-marketing/how-to-integrate-getresponse-with-fluent-forms/4.-Generate-API-Key-scaled.webp)

Provide a **Name** for your **API key** and click the **Generate** button.

![Generate Button Fluent Forms](/images/integrations/email-marketing/how-to-integrate-getresponse-with-fluent-forms/5.-Generate-button-scaled.webp)

Finally, your GetResponse API key is generated, copy it by clicking the **Copy** button.

![Copy API Key](/images/integrations/email-marketing/how-to-integrate-getresponse-with-fluent-forms/6.-Copy-API-Key.webp)
...
5. **Conditional Logics:** This option allows GetResponse integration to function conditionally based on your submission values according to your set conditional logic/s. To learn more, read the [Conditional Logic guide](/set-up-forms-with-conditional-logic-in-fluent-forms).
...
![Save Feed Button Integrate GetResponse](/images/integrations/email-marketing/how-to-integrate-getresponse-with-fluent-forms/12.-Save-Feed-button-scaled.webp)
