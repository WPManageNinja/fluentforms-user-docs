...
> [!Note]
> **Salesflare** requires **Fluent Forms Pro**. See [Upgrade to Fluent Forms Pro Add-on](/upgrade-to-fluent-forms-pro-add-on).
...
![Enable Salesflare Integration](/images/integrations/crm/salesflare-integration-with-fluent-forms/enable-salesflare-integration-01-scaled.webp)
...
![Create API Key](/images/integrations/crm/salesflare-integration-with-fluent-forms/create-api-key-03-scaled.webp)

Here appears a popup. Enter the **API Name** and then click the **Create** button.

After creating the API key, **copy** it for **later** use.

![Create API Key](/images/integrations/crm/salesflare-integration-with-fluent-forms/create-api-key-04-1-scaled.webp)
...
![Enter Salesflare API Key](/images/integrations/crm/salesflare-integration-with-fluent-forms/enter-salesflare-api-key-05-01-09-2025_03_42_PM-scaled.webp)
...
**E. Conditional Logic:**  If you want to allow **Salesflare** integration conditionally based on your submission values then **Enable Conditional Logic** options. To learn more, read [Set up Forms with Conditional Logic in Fluent Forms](/set-up-forms-with-conditional-logic-in-fluent-forms).
...
![Add Salesflare Integration Feed](/images/integrations/crm/salesflare-integration-with-fluent-forms/Add-New-Salesflare-Integration-Feed-08-scaled.webp)
...
You can see these form submissions from the **Entries** section of this particular form. Learn more about [managing entries in Fluent Forms](/managing-entries-in-fluent-forms).

![Entries Fluent Forms](/images/integrations/crm/salesflare-integration-with-fluent-forms/Forms-Entries-10-scaled.webp)

Go to the **Salesflare Contacts** section from the left sidebar and see the integrated contact list into Fluent Forms.

![Salesflare Contacts](/images/integrations/crm/salesflare-integration-with-fluent-forms/salesflare-contacts-11-scaled.webp)
