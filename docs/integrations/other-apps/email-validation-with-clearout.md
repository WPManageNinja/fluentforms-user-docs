...
![](/images/integrations/other-apps/email-validation-with-clearout/create-app-01-scaled.webp)

Once the app is created, an **API** token will be generated. **Copy** this token for later use.

![](/images/integrations/other-apps/email-validation-with-clearout/api-token-02-scaled.webp)
...
![](/images/integrations/other-apps/email-validation-with-clearout/email-validation-03-scaled.webp)
...
![](/images/integrations/other-apps/email-validation-with-clearout/paste-api-token-04-scaled.webp)
