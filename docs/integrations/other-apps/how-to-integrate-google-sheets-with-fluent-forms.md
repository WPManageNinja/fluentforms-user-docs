...
> [!Note]
> **Google Sheets** requires **Fluent Forms Pro**. See [Upgrade to Fluent Forms Pro Add-on](/upgrade-to-fluent-forms-pro-add-on).
...
![Enabled Google Sheet Module](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/1.-Enabled-Google-Sheet-module-scaled.webp)
...
![Paste Code Fluent Forms](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/5.-Paste-code-scaled.webp)
...
![Disconnect Goggle Sheet](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/6.-Disconnect-Goggle-Sheet-scaled.webp)
...
![Add Integration Button Integrate Google Sheets](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/8.-Add-new-integration-button-scaled.webp)
...
![Copy Spreadsheet ID And Worsheet Name](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/10.-Copy-Spreadsheet-ID-and-Worsheet-Name-scaled.webp)
...
This option allows Google Sheets integration to function conditionally based on your submission values according to your set conditional logic/s. To learn more, read the [Conditional Logic guide](/set-up-forms-with-conditional-logic-in-fluent-forms). 
...
![Added Google Sheets Integration Feed](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/11.-Added-Google-Sheets-Integration-Feed-scaled.webp)
...
![Entries Tab Fluent Forms](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/12.-Entries-tab-scaled.webp)
...
![Preview Added Entries Integrate Google Sheets](/images/integrations/other-apps/how-to-integrate-google-sheets-with-fluent-forms/13.-Preview-of-added-entries-scaled.webp)
