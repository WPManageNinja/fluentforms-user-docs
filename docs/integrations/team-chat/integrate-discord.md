---
description: "Fluent Forms allows you to integrate with Discord to send desired information as instant notifications to your Discord channel when a form is submitted."
---
