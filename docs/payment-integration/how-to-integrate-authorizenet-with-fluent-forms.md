...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/enable-authorized-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/credentials-02-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/API-Credentials-03-scaled.webp)

Here appears a new pop-up. Simply, click on the **SUBMIT** button.

![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/submit-button-04.webp)

Here, a new pop-up arrives. Enter the passcode from your mail and click the **CONFIRM** button.

![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/passcode-05.webp)

Now your **Transaction key** has been generated. **Copy** this for future use.

![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/new-transaction-key-created-06.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/new-signature-key-created-07-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/access-webhook-08-scaled.webp)

Here appears a new pop-up. Now, click the **Create a Webhook notification** button.

![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/create-a-webhook-notification-09-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/webhook-information-added-10-scaled.webp)

Now, your webhook is in an active status.

![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/webhook-active-11-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/save-settings-12-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/Edit-form-13-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/payment-method-label-14-scaled.webp)
...
![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/Copy-forms-shortcode-15-scaled.webp)

## Preview of Added Payment Method

Here is the preview of the **Payment Method** that we just added. 

![](/images/payment-integration/how-to-integrate-authorizenet-with-fluent-forms/preview-of-authorized-payment-16.webp)
