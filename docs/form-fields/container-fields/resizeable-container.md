---
description: "Fluent Forms gives users complete control over configuring Column Width. Previously, you had to use the Global Styler or CSS to adjust column widths."
---
...
First, open **Fluent Forms** and **drag and drop** to add a container field, or click the **Plus Icon** to add the [Container](/add-container-fields) field to your form. Add the necessary fields inside the container ( **Name**, **Email**, **Radio** **Button**, **Custom** **Submit Button** **etc**.).

![Resizable Container](/images/form-fields/container-fields/resizeable-container/resizable-container-01-scaled.webp)
...
![Resizeable Container step](/images/form-fields/container-fields/resizeable-container/gif.gif)
...
![Resizeable Container step](/images/form-fields/container-fields/resizeable-container/7.webp)

### Preview of the Resizable Container

Preview your form to see how the container adapts to the new column width. 

![Preview](/images/form-fields/container-fields/resizeable-container/unnamed-2-3.webp)
