...
First, open **Fluent Forms** and **drag and drop** to add a container field, or click the **Plus Icon** to add the [Container](/add-container-fields-in-fluent-forms) field to your form. Add the necessary fields inside the container ( **Name**, **Email**, **Radio** **Button**, **Custom** **Submit Button** **etc**.).
...
![Resizeable Container step](/images/form-fields/container-fields/resizeable-container-in-fluent-forms/gif.gif)
...
![Resizeable Container step](/images/form-fields/container-fields/resizeable-container-in-fluent-forms/7.webp)

### Preview of the Resizable Container

Preview your form to see how the container adapts to the new column width. 

![Preview](/images/form-fields/container-fields/resizeable-container-in-fluent-forms/unnamed-2-3.webp)
