---
description: "The rating input field in Fluent Forms allows users to provide feedback quickly, making it a great fit for surveys and polls."
---

# Ratings Input Field

The **rating** input field in Fluent Forms allows users to provide feedback quickly, making it a great fit for [surveys and polls](/surveys-and-polls). By default, the field includes five rating levels: **Nice, Good, Very Good, Awesome, and Amazing**. You can customize and add more rating options as needed.

This guide walks you through adding and customizing the **Ratings** field in Fluent Forms.

> [!Note]
> The **Ratings** field requires **Fluent Forms Pro**. See [Upgrade to Fluent Forms Pro Add-on](/upgrade-to-pro-add-on).
...
![Edit form to add Ratings field](/images/form-fields/advanced-fields/ratings-input-field/edit-form-01-10-scaled.webp)
...
![Add Ratings field to the form](/images/form-fields/advanced-fields/ratings-input-field/new-15-scaled.webp)
...
![Ratings field customization panel](/images/form-fields/advanced-fields/ratings-input-field/input-customization-03-15-scaled.webp)
...
![Ratings field basic options](/images/form-fields/advanced-fields/ratings-input-field/Basic-options-04-13-scaled.webp)
...
![Ratings preset icon options](/images/form-fields/advanced-fields/ratings-input-field/icon-source-1-scaled.webp)
...
![Ratings custom SVG and color settings](/images/form-fields/advanced-fields/ratings-input-field/custom-svg-2-scaled.webp)
...
**C. Conditional Logic:** Show or hide the field based on other values. See [Set up Forms with Conditional Logic in Fluent Forms](/set-up-forms-with-conditional-logic).

![Ratings advanced options](/images/form-fields/advanced-fields/ratings-input-field/Advanced-options-05-11-scaled.webp)
...
![Save and embed the form](/images/form-fields/advanced-fields/ratings-input-field/Save-Form-06-15-scaled.webp)

### Preview of Added Ratings Input Field

Here is a preview of the form with the **Ratings** field.

![Ratings field frontend preview](/images/form-fields/advanced-fields/ratings-input-field/rating-preview.webp)
