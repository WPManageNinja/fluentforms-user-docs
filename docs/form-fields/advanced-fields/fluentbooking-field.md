...
![Edit FluentBooking Field in Fluent](/images/form-fields/advanced-fields/fluentbooking-field/Form-edit-01-4-scaled.webp)
...
![Adding Booking](/images/form-fields/advanced-fields/fluentbooking-field/adding-Fluent-Booking-02-scaled.webp)
...
![Input Customization Fluent Forms](/images/form-fields/advanced-fields/fluentbooking-field/Input-Customization-03-33-scaled.webp)
...
![Booking Options](/images/form-fields/advanced-fields/fluentbooking-field/Fluent-booking-options-04-scaled.webp)
...
**C. Conditional Logic:** This option allows you to create specific rules to dynamically hide/show the input field to function conditionally based on your submission values according to your set of conditional logic. To learn more, read the [Conditional Logic documentation](/set-up-forms-with-conditional-logic). 

![Advanced Options Fluent Forms](/images/form-fields/advanced-fields/fluentbooking-field/Advanced-options-05-22-scaled.webp)
...
![Save FluentBooking Field in Fluent](/images/form-fields/advanced-fields/fluentbooking-field/Save-Form-06-28-scaled.webp)

### Preview of Added FluentBooking Field

Here is a preview of the form with the **FluentBooking** field.

![Preview FluentBooking Field in Fluent](/images/form-fields/advanced-fields/fluentbooking-field/Preview-07-19-scaled.webp)
