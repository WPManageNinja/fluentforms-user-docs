...
<div class="youtube-embed">
  <iframe src="https://www.youtube.com/embed/fdMzDnwAa2w" title="YouTube video player" frameborder="0" allow="accelerated-sensors; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
</div>
...
![Editor Fluent Forms](/images/form-fields/general-fields/radio-field/Editor-Form-01-scaled.webp)
...
![Radio Field step](/images/form-fields/general-fields/radio-field/new-10-scaled.webp)
...
![Input Customization](/images/form-fields/general-fields/radio-field/Input-customization-03-8-scaled.webp)
...
**E. Show & Calc Value:** Users will get **Show** and **Calc** Values options. You may display your data and perform [numeric calculations](/numeric-calculation) using Show Values and Calc Values.
...
![Basic Options](/images/form-fields/general-fields/radio-field/Basic-options-04-8-scaled.webp)

### Advanced Options

Advanced settings allow further customization to meet specific use cases.

**A. Dynamic Default Value:** Using our shortcodes, you can manually set any fixed value in your field and pre-fill your input field dynamically. Read [Dynamic Default Value in Fluent Forms](/dynamic-default-value) to better understand Dynamic Default values.
...
![Advanced Option X439](/images/form-fields/general-fields/radio-field/Advanced-option-05-1-1024x439.webp)
...
![Save Radio Field](/images/form-fields/general-fields/radio-field/Save-Form-06-9-scaled.webp)

### Preview of Radio Button Field

Here is the preview of the added **Radio Button** field under the Form. 

![Preview Radio Field](/images/form-fields/general-fields/radio-field/preview-07-4.webp)

### Image Button Layout

First, enable the **Photo** Option from your radio field’s options. Then, **Upload** images for each option in the **Photo** setting.

![Photo](/images/form-fields/general-fields/radio-field/Photo-08-1-scaled.webp)
...
![Button Layout Radio Field](/images/form-fields/general-fields/radio-field/button-layout-09-scaled.webp)

Once configured, the radio button field will display with clickable image options.

![Button Style Preview Radio Field](/images/form-fields/general-fields/radio-field/button-style-preview-10.webp)
