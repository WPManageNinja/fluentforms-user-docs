...
![Edit form to add Dropdown field](/images/form-fields/general-fields/dropdown-field/edit-form-01-1-scaled.webp)
...
![Add Dropdown field to the form](/images/form-fields/general-fields/dropdown-field/new-3-scaled.webp)
...
![Dropdown field customization panel](/images/form-fields/general-fields/dropdown-field/Input-Customization-03-1-scaled.webp)
...
**F. Show & Calc Value:** Display values and use them in [numeric calculations](/numeric-calculation).
...
![Dropdown field options settings](/images/form-fields/general-fields/dropdown-field/input-customization-1-scaled.webp)
...
![Dropdown option grouping settings](/images/form-fields/general-fields/dropdown-field/input-customization-2-scaled.webp)
...
![Save and embed the form](/images/form-fields/general-fields/dropdown-field/Save-Form-06-3-scaled.webp)

## Preview of Added Dropdown Field

Here is a preview of the form with the **Dropdown** field.

![Dropdown field frontend preview](/images/form-fields/general-fields/dropdown-field/Preview-07-1.webp)
