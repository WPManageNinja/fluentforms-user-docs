...
> [!Note]
> The **Image Upload** field requires **Fluent Forms Pro**. See [Upgrade to Fluent Forms Pro Add-on](/upgrade-to-pro-add-on).
...
![Edit form to add Image Upload field](/images/form-fields/general-fields/image-upload-input-field/Edit-Form-01-3-scaled.webp)
...
![Add Image Upload field to the form](/images/form-fields/general-fields/image-upload-input-field/new-7-scaled.webp)
...
![Image Upload field customization options](/images/form-fields/general-fields/image-upload-input-field/customize-the-image-upload-3-scaled.webp)
...
![Image Upload field options](/images/form-fields/general-fields/image-upload-input-field/image-upload-option-1-scaled.webp)
...
![Image Crop settings](/images/form-fields/general-fields/image-upload-input-field/image-upload-option-2-scaled.webp)
...
**E. Conditional Logic:** Show or hide the field based on other field values. See [Set up Forms with Conditional Logic in Fluent Forms](/set-up-forms-with-conditional-logic).

![Image Upload advanced options](/images/form-fields/general-fields/image-upload-input-field/Advanced-Options-05-5-scaled.webp)
...
![Save and embed the form](/images/form-fields/general-fields/image-upload-input-field/Save-Form-06-6-scaled.webp)

## Preview of Added Image Upload Field

Here is a preview of the form with the **Image Upload** field.

![Image Upload field frontend preview](/images/form-fields/general-fields/image-upload-input-field/Preview-07-2.webp)
