...
![Step one fields](/images/creating-forms/specialized-form-types/creating-a-multi-step-form-in-fluent-forms/3.-Adding-Input-Fields-under-Paging-Start-scaled.webp)

Also, you can customize this part by clicking the **Pencil/Edit Icon** when hovering over the field. 

![Paging Start settings](/images/creating-forms/specialized-form-types/creating-a-multi-step-form-in-fluent-forms/4.-Edit-Paging-Start-step-1-scaled.webp)

In the **Input Customization** tab, configure these **Paging Start** options:
...
![Multi-step form preview](/images/creating-forms/specialized-form-types/creating-a-multi-step-form-in-fluent-forms/Preview-06-4.webp)
