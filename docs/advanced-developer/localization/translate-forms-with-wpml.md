...
> The Datepicker UI (month names, weekdays, AM/PM) is not handled by WPML. To localize it, see [Translate Datepicker Field of Fluent Forms](/translate-datepicker-field-of-fluent-forms-plugin).
