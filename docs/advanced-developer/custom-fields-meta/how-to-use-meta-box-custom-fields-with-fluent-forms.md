# How to use Meta Box Custom Fields
...
Now, select an existing [**Post Form**](/how-to-create-a-post-form-with-fluent-forms) from the Fluent Forms dashboard or create a new one. 
...
**F. Enable Conditional Logic:** If you want to allow **MetaBox Post** conditionally based on your submission values, then **Enable Conditional Logic** options. To learn more about this conditional logic, read the [Conditional Logic in Fluent Forms](/set-up-forms-with-conditional-logic-in-fluent-forms) guide.
