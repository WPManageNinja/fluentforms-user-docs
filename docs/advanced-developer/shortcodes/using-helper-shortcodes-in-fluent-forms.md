...
If you have set a maximum entry limit using the [form restrictions feature](/form-restrictions-feature-in-fluent-forms), you can display how many submission slots are still available.
