...
These codes work if you use [**FluentCRM**](/fluentcrm-integration) and want to **auto-fill contact details**. To populate fields directly from a logged-in contact's profile, see [Pre-Fill Form Fields with FluentCRM Data](/pre-fill-form-fields-with-fluentcrm-data).
