...
Fluent Forms offers various **dynamic smart codes** that can be used in the form builder to set [**default input values**](/dynamic-default-value-in-fluent-forms). These codes pull information from your **website, user profile, post details,** and **FluentCRM contacts**.
...
These codes work if you use [**FluentCRM**](/fluentcrm-integration-with-fluent-forms) and want to **auto-fill contact details**. To populate fields directly from a logged-in contact's profile, see [Pre-Fill Form Fields with FluentCRM Data](/pre-fill-form-fields-with-fluentcrm-data).
