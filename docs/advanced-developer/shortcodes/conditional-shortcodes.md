...
> [!Note]
> **Conditional shortcodes** require **Fluent Forms Pro**. See [Upgrade to Fluent Forms Pro Add-on](/upgrade-to-pro-add-on).
...
![Conditional Shortcode](/images/advanced-developer/shortcodes/conditional-shortcodes/Conditional-shortcode-01-scaled.webp)
...
For example,  you have a [radio button field](/radio-field) and want to show a message only when the user selects **"Yes"**, you can write-
...
![Show Value](/images/advanced-developer/shortcodes/conditional-shortcodes/show-value-02.webp)
