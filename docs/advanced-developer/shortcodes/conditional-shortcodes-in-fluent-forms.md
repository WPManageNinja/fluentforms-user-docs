...
> [!Note]
> **Conditional shortcodes** require **Fluent Forms Pro**. See [Upgrade to Fluent Forms Pro Add-on](/upgrade-to-fluent-forms-pro-add-on).
...
For example,  you have a [radio button field](/radio-field-in-fluent-forms) and want to show a message only when the user selects **"Yes"**, you can write-
