---
description: "Fluent Forms offers powerful helper shortcodes that enable you to display dynamic form data, including submission counts, entry details, and payment…"
---

# Using Helper Shortcodes

Fluent Forms offers powerful helper shortcodes that enable you to display dynamic form data, including submission counts, [entry details](/managing-entries), and [payment statuses](/payment-reports), anywhere on your website. The helper shortcodes and all of their attributes are listed below.
...
![Submission Info Fluent Forms](/images/advanced-developer/shortcodes/using-helper-shortcodes/Submission-info.webp)
...
![Creation Date Fluent Forms](/images/advanced-developer/shortcodes/using-helper-shortcodes/creation-date.webp)
...
![Entry Status Fluent Forms](/images/advanced-developer/shortcodes/using-helper-shortcodes/Entry-Status-scaled.webp)
...
If you have set a maximum entry limit using the [form restrictions feature](/form-restrictions-feature), you can display how many submission slots are still available.
...
![Maximum Number Entries](/images/advanced-developer/shortcodes/using-helper-shortcodes/Maximum-number-of-entries-scaled.webp)
...
![All Entries Fluent Forms](/images/advanced-developer/shortcodes/using-helper-shortcodes/all-entries.webp)
...
![Payment Status Fluent Forms](/images/advanced-developer/shortcodes/using-helper-shortcodes/Payment-Status-scaled.webp)
