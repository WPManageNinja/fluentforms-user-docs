...
![](/images/form-entries/how-to-add-a-date-and-time-stamp-to-form-entries/defualt-date-and-time-01-scaled.webp)
...
![](/images/form-entries/how-to-add-a-date-and-time-stamp-to-form-entries/Hidden-field-02-scaled.webp)
...
![](/images/form-entries/how-to-add-a-date-and-time-stamp-to-form-entries/03-1-scaled.webp)

When a user submits the form, the custom date and time stamp will automatically appear in the **Entries** section.

![](/images/form-entries/how-to-add-a-date-and-time-stamp-to-form-entries/04-scaled.webp)
