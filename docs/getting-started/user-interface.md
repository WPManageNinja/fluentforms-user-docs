...
![Dashboard](/images/getting-started/user-interface/filter-form-01-scaled.webp)
...
![Form Menu](/images/getting-started/user-interface/unnamed-3.webp)
...
![Category](/images/getting-started/user-interface/form-category-02-1-scaled.webp)
...
> [!Note]
> If you do not have any existing forms, read [How to Create a Form with Fluent Forms](/create-a-form) or [Using and Customizing Pre-built Quick Forms in Fluent Forms](/using-and-customizing-pre-built-quick-forms) to create a new one.

![Form Builder](/images/getting-started/user-interface/Form-builder-scaled.webp)
...
* **Create Conversational Form:** Use this option to start building a conversational-style form. See [How to create a conversational form](/create-a-conversational-form).
* **Create a Post Form:** Select this template to create a form that can generate WordPress posts. See [How to Create a Post Form with Fluent Forms](/create-a-post-form).
* **Create a Form with AI:** Choose this option to generate a form using AI. See [How to Create a Form with Fluent Forms AI](/create-a-form-with-ai).

![Form Template](/images/getting-started/user-interface/Form-template-04.webp)
...
* **Import Entries:** Import entries from other sources. See [Importing Entries in Fluent Forms](/importing-entries) and [Managing Entries in Fluent Forms](/managing-entries).

![Entries](/images/getting-started/user-interface/entries-05-scaled.webp)
...
* **Transactions List:** When you click the **Payments** menu, you see all transactions made through your forms and can view payment details for each form separately. See [Configure Payment Settings with Fluent Forms](/configure-payment-settings).

![Payment](/images/getting-started/user-interface/Payment-07-scaled.webp)
...
![Global Settings](/images/getting-started/user-interface/Settings-08-scaled.webp)
...
* **Migrator:** Migrate forms from other plugins. See [Fluent Forms Migrator](/migrator-wpforms-contact-form-7-gravity-forms-ninja-forms-caldera-forms).
* **Form Activity:** Monitor form activity.

![Tools](/images/getting-started/user-interface/tools-09-scaled.webp)
...
* **Fluent Forms PDF:** Generate and download form submissions as PDF files. See [Fluent Forms PDF Module](/pdf-module).

![Integration](/images/getting-started/user-interface/Integration-09-scaled.webp)
...
![Support](/images/getting-started/user-interface/Support.webp)
