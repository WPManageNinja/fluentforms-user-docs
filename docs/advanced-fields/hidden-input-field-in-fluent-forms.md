...
![](/images/advanced-fields/hidden-input-field-in-fluent-forms/edit-form-01.png)
...
![](/images/advanced-fields/hidden-input-field-in-fluent-forms/new.png)
...
![](/images/advanced-fields/hidden-input-field-in-fluent-forms/input-customization-03.png)
...
![](/images/advanced-fields/hidden-input-field-in-fluent-forms/customization-04.png)
...
![](/images/advanced-fields/hidden-input-field-in-fluent-forms/save-form-05.png)

### Preview of Added Hidden Field

Here is the **Preview** of the **Form** to test the hidden field functionality.

![](/images/advanced-fields/hidden-input-field-in-fluent-forms/preview-06-1.png)

After that, click the **Entries** section of this form. You will see the entry result for your **Hidden fields**.

![](/images/advanced-fields/hidden-input-field-in-fluent-forms/input-hidden-07.png)
