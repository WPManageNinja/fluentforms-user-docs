...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/1.-Enable-Platformly--scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/2.-Platformly-API-Settings-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/3.-APIs-Docs-Keys-scaled.webp)

Now, to create an API Key, click either the **Plus Icon** on the top right side or the **Add First API Key** button in the middle.     

![](/images/automation/how-to-integrate-platformly-with-fluent-forms/4.-Add-frst-API-Key-or-Plus-icon-scaled.webp)

Here, provide a **Name** for the **API Key** you are creating and click the **Submit** button.     

![](/images/automation/how-to-integrate-platformly-with-fluent-forms/5.-Name-API-Key-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/6.-Copy-API-Key-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/7.-Setup-option-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/8.-Copy-Project-ID-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/9.-Paste-the-API-Key-and-Project-ID-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/10.-Verify-or-Disconnect-Platformly-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/11.-Open-desired-form-Settings-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/12.-Add-new-integration-dropdown-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/13.-Select-Platformly-Segment-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/14.-Save-Feed-button-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/15.-Added-Platformly-Integration-Feed-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/16.-Form-Entries-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/17.-Added-contacts-under-the-selected-segment-scaled.webp)
...
![](/images/automation/how-to-integrate-platformly-with-fluent-forms/18.-Contacts-preview-scaled.webp)
