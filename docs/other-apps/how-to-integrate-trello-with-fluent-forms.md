...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/1.-enabled-Trello-module-scaled.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/2.-Trello-API-Settings-scaled.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/3.-Allow-button.webp)

Once you click allow, Trello will provide the access key. Now, simply copy it. 

![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/4.-Copy-API-Key-2.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/5.-Paste-API-Key-scaled.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/6.-Verify-or-Disconnect-button-scaled-2.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/7.-Open-desired-Form-Settings-1-scaled.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/8.-Add-New-Integration-button-1-scaled.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/9.-Save-Feed-button-2-scaled.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/10.-Added-Trello-Integration-Feed-scaled.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/11.-Entries-tab.webp)
...
![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/12.-preview-of-Added-cards-scaled.webp)

You can also see the details of one user by clicking the desired card of that user.

![](/images/other-apps/how-to-integrate-trello-with-fluent-forms/13.-Preview-of-details-of-a-specific-card.webp)
