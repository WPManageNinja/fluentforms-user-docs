...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/1.-Enabled-Airtable-module-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/2.-Airtable-Settings-page-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/3.-Profile-Builder-Hub-option-scaled.webp)

Now, open the **Personal Access tokens** under the **Developers** tab and click the **+Create new token** button.

![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/4.-Create-New-Token-scaled-2.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/5.-Name-scope-base-Create-Token-button.webp)

Now, a pop-up will come with your access token. Simply, copy it from here.

![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/6.-Copy-Token.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/7.-Paste-Access-Token-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/8.-Verify-or-Disconnect-button-scaled-3.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/9.-Open-desired-Form-Settings-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/10.-Add-New-Integration-button-scaled-2.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/11.-Select-Table-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/12.-Save-Feed-button-scaled-3.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/13.-Added-Airtable-Integration-Feed-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/14.-Entries-tab-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/15.-Desired-worspace-scaled.webp)
...
![](/images/other-apps/how-to-integrate-airtable-with-fluent-forms/16.-Preview-of-added-contacts-scaled.webp)
