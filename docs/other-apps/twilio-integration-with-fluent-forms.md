...
![](/images/other-apps/twilio-integration-with-fluent-forms/enable-twilio-01-scaled.webp)

Once you enable Twilio, you will be asked for the **Twilio Credentials**.

![](/images/other-apps/twilio-integration-with-fluent-forms/02-8-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/Twilio-credentials-03-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/Globql-settings-04-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/Disconnect-Twilio-05-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/settings-form-06-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/sms-notification-by-twilio-07-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/Add-New-Twilio-Integration-Feed-08-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/Success-twilio-integration-09-scaled.webp)
...
![](/images/other-apps/twilio-integration-with-fluent-forms/entries-10-1-scaled.webp)
