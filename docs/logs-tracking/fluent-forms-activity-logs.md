...
![](/images/logs-tracking/fluent-forms-activity-logs/1.-Tools-Activity-Logs-scaled.webp)
...
![](/images/logs-tracking/fluent-forms-activity-logs/2.-Form-filter-option-scaled.webp)
...
![](/images/logs-tracking/fluent-forms-activity-logs/3.-Source-filter-option-scaled.webp)

#### 3. Status

You also have the option to filter your activity logs based on the **Status** (**Success**, **Info**, and **Failed**) of your forms.

![](/images/logs-tracking/fluent-forms-activity-logs/4.-Status-filter-option-scaled.webp)

#### 4. Date

With this option, you can filter your activities by selected **Dates** to see actions for specific days.

![](/images/logs-tracking/fluent-forms-activity-logs/5.-Date-filter-option-scaled.webp)

**To show the use of all filtering options at a glance, follow the GIF below:**

![](/images/logs-tracking/fluent-forms-activity-logs/6.-Four-filter-dropdowns-Drift-video.gif)
...
![](/images/logs-tracking/fluent-forms-activity-logs/7.-Brief-actitivity-check-by-Arrow-Icon.webp)
...
![](/images/logs-tracking/fluent-forms-activity-logs/8.-Click-the-desired-Submission-Id.webp)
...
![](/images/logs-tracking/fluent-forms-activity-logs/9.-Detailed-entry-info-of-a-log-scaled.webp)

### Delete Activity Logs

If you want to delete any activity log, you can do it simply by clicking the **Delete Icon** under the **Action** column.

![](/images/logs-tracking/fluent-forms-activity-logs/10.-Delete-Single-activity-log-scaled.webp)
...
![](/images/logs-tracking/fluent-forms-activity-logs/11.-Delete-in-bulk-scaled.webp)
