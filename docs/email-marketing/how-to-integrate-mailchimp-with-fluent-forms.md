...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/1.-Enabled-Mailchimp-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/2.-Configure-Integrations-1-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/3.-Profile-Icon-of-Mailchimp-scaled.webp)

Now, open the **Extras** tab and select the **API keys** from the dropdown list.

![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/4.-Extras-API-Key-button-scaled.webp)

Then, press the **Create A Key** button.

![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/5.-Create-API-Key-button.webp)

Provide a **Name** for your API key and click the **Generate Key** button.

![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/6.-Generate-API-Key.webp)

Finally, your Mailchimp API key is generated, copy it by clicking the **Copy to Clipboard** button.

![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/7.-Copy-API-key.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/8.-Paste-API-Key-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/9.-VerifyDisconnect-API-Key-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/Open-Desired-Form-Settings-5-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/10.-Add-New-Integration-button-1-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/11.-Mailchimp-List-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/12.-Save-Settings-button-scaled.webp)
...
![](/images/email-marketing/how-to-integrate-mailchimp-with-fluent-forms/13.-Added-Mailchimp-Integration-Feed-scaled.webp)
