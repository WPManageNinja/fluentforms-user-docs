...
Before using hCaptcha, you must configure it with a **Site Key** and **Secret key**. To learn more, read [How to Integrate hCaptcha with Fluent Forms](/integrate-hcaptcha).
...
![hCaptcha step](/images/security-spam/hcaptcha/new-14-scaled.webp)
...
![Input Customization Fluent Forms](/images/security-spam/hcaptcha/input-customization-03-14-scaled.webp)
...
![Input Customize](/images/security-spam/hcaptcha/input-customize-04-scaled.webp)
...
![Save hCaptcha](/images/security-spam/hcaptcha/save-form-05-1-scaled.webp)

### Preview of Added hCaptcha Field

Here is a preview of the form with the **hCaptcha** field:

![Preview hCaptcha](/images/security-spam/hcaptcha/preview-form-06.webp)
