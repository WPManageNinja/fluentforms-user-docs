...
![](/images/crm/amocrm-integration-with-fluent-forms/Enable-amoCRM-integrationj-01-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/configure-amocrm-02-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/create-Integration-03-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/set-redirect-url-04.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/copy-integration-id-and-secret-key-05.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/credential-save-06-scaled.webp)

Now, you will automatically be redirected to the **AmoCRM Account** page. Select the account, and click on the **Allow** button. 

![](/images/crm/amocrm-integration-with-fluent-forms/amocrm-account-select-06.webp)

Here, you can see your **API integration is up and running**.  To disconnect, click the **Disconnect Amocrm** button.

![](/images/crm/amocrm-integration-with-fluent-forms/disconnect-amocrm-7-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/Form-Setting-amoCRM-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/amocrm-integration-08-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/Add-New-Amocrm-Integration-Feed-09-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/amocrm-preview-10-scaled.webp)
...
![](/images/crm/amocrm-integration-with-fluent-forms/contact-list-amocrm-11-scaled.webp)
