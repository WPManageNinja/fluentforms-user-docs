...
![](/images/crm/zoho-crm-integration-with-fluent-forms/enable-zohocrm-01-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/fdsgdh.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/choose-server-type-02-1-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/create-new-client-03-scaled.webp)

Now, You will be provided with the **Client ID** and **Client Secret. Copy** the Client ID and Client Secret for **later** use.

![](/images/crm/zoho-crm-integration-with-fluent-forms/Client-ID-and-Client-Secret-04.webp)

Then go to **Settings** and **Enable** the **Data Centers** as you need.

![](/images/crm/zoho-crm-integration-with-fluent-forms/Settings-05-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/Global-Settings-08-scaled.webp)

Then it is redirect to your Zoho CRM account for your confirmation. Click the **Accept** button.

![](/images/crm/zoho-crm-integration-with-fluent-forms/accept-07.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/disconect-09-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/Fluent-Form-Zoho-forms-10-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/add-new-configuration-11-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/add-new-zoho-13-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/14-scaled.webp)
...
![](/images/crm/zoho-crm-integration-with-fluent-forms/Zoho-entries-scaled.webp)
