...
![](/images/crm/drip-integration-with-fluent-forms/enable-drip-integration-01-scaled.webp)

Once you enable **Drip**, you will be asked for the **Drip API Token** and **Drip Account ID** of your **Drip Account**.

![](/images/crm/drip-integration-with-fluent-forms/Drip-integration-02-scaled.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/user-settings-03-scaled.webp)

You can get the API token from the User Info page. **Copy** the **API Token** for future use.

![](/images/crm/drip-integration-with-fluent-forms/api-token-900.webp)

Next, **Back to the Dashboard** and click the **Accounts** options from the **Settings** sections. 

![](/images/crm/drip-integration-with-fluent-forms/account-settings-04-2-scaled.webp)

Now, scroll down and you will find the **Account ID** here. Just **Copy** it for **later** use.

![](/images/crm/drip-integration-with-fluent-forms/account-ID-05-2-1024x515.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/paste-api-and-id-06-scaled.webp)

Here, you can see your **Drip API integration is up and running**. To disconnect, click the **Disconnect Drip** button.

![](/images/crm/drip-integration-with-fluent-forms/drip-success-06-1-scaled.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/form-setting-07-scaled.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/drip-inttegration-02.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/add-new-configuration-08-1.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/Done-integration-fields-09-scaled.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/Entries-10-scaled.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/Drip-active-11-scaled.webp)
...
![](/images/crm/drip-integration-with-fluent-forms/Contact-list-of-drip-12-scaled.webp)
