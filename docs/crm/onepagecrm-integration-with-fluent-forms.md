...
![](/images/crm/onepagecrm-integration-with-fluent-forms/enable-onepagecrm-01-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/Global-Settings-02-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/apps-and-integration-03-scaled.webp)

Now, Scroll down and select the **API** options.

![](/images/crm/onepagecrm-integration-with-fluent-forms/Api-04-scaled.webp)

Here you will find **User ID** and **API Key** under the Configuration sections. Now, **Copy** the **User ID** and **API Key** for **later** use.

![](/images/crm/onepagecrm-integration-with-fluent-forms/user-id-and-api-key-05-1-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/paste-user-id-and-api-key-06-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/disconnect-onepagecrm-07-1-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/Form-Setting-08-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/add-ne-integration-09-scaled.webp)
...
**C. Conditional Logic:** If you want to allow **OnePageCrm** integration conditionally based on your  submission values, **Enable Conditional Logic** options. To learn more about conditional logic, read the[ article](/docs/set-up-forms-with-conditional-logic-in-fluent-forms).

**D. Status:** Enable this feed option to activate the integration.

Now, click the **Save Feed** button to save the integration feed.

![](/images/crm/onepagecrm-integration-with-fluent-forms/Add-New-OnePageCrm-Integration-Feed-10-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/toggle-integration-11-scaled.webp)
...
![](/images/crm/onepagecrm-integration-with-fluent-forms/Entries-of-onepagecrm-12-scaled.webp)

Go to the **OnePageCrm Contacts** section from the left sidebar to see the integrated contact list into Fluent Forms.

![](/images/crm/onepagecrm-integration-with-fluent-forms/Contacts-of-Onepagecrm-13-scaled.webp)
