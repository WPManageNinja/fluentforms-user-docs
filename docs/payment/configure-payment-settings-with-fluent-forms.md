...
![](/images/payment/configure-payment-settings-with-fluent-forms/1.-General-tab-under-Payment-Settings-scaled.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/2.-Currency-settings-tab-scaled.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/3.-Page-and-Subscription-Management-tab-1-scaled.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/4.-Payment-History-shortcode-scaled.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/5.-Preview-of-Payment-History.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/6.-Payment-Receipt-shortcode-scaled.webp)

Here, you can see the **Preview** of a single **Payment Receipt** under the **Payment Receipt** page. 

![](/images/payment/configure-payment-settings-with-fluent-forms/7.-Form-of-a-specific-Pyment-Receipt.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/8.-Payment-History-View-button.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/9.-Subscription-Management-option.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/Open-Form-Settings-3-scaled.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/4.-Form-specific-Payment-Settings-scaled.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/5.-Form-specific-payment-method-settings-scaled.webp)
...
![](/images/payment/configure-payment-settings-with-fluent-forms/7.-Enable-desired-payment-methods-globally-for-all-forms-scaled.webp)
