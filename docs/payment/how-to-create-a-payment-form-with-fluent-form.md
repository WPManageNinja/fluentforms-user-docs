...
![](/images/payment/how-to-create-a-payment-form-with-fluent-form/1.-Open-desired-form-Editor-1-scaled.webp)

Once you open the **Editor** page, you need to add the necessary fields from the **Payment Fields** module. 

![](/images/payment/how-to-create-a-payment-form-with-fluent-form/2.-Payment-Fields-scaled.webp)
...
![](/images/payment/how-to-create-a-payment-form-with-fluent-form/3.-Enable-payment-module-scaled.webp)
...
![](/images/payment/how-to-create-a-payment-form-with-fluent-form/4.-Payment-Item-and-Payment-Method-fields-scaled.webp)
...
![](/images/payment/how-to-create-a-payment-form-with-fluent-form/5.-EditPencil-icon-of-payment-itel-field-scaled.webp)
...
![](/images/payment/how-to-create-a-payment-form-with-fluent-form/6.-Enable-desired-payment-methods-globally-for-all-forms-scaled.webp)
...
![](/images/payment/how-to-create-a-payment-form-with-fluent-form/9.-Save-Payment-Form-scaled.webp)

Then, open a desired page/post, **paste** the **shortcode**, and press the **Save** button.

![](/images/payment/how-to-create-a-payment-form-with-fluent-form/10.-Paste-shortcode-on-dsired-page-scaled.webp)

## Preview of Payment Form

Here is the **preview** of the **Payment Form** that we just created.

![](/images/payment/how-to-create-a-payment-form-with-fluent-form/11.-Preview-of-Payment-form.webp)
