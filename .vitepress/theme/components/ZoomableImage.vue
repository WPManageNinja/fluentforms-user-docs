...
// useRoute() must not run during the SSR pass — it throws and takes the build down.
...
// Reset zoom state and drop global listeners on SPA navigation — no leaks, no overlay
